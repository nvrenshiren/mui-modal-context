...
*/
var aa=__webpack_require__(24),m=__webpack_require__(418),r=__webpack_require__(840);function y(a){for(var b="https://reactjs.org/docs/error-decoder.html?invariant="+a,c=1;c<arguments.length;c++)b+="&args[]="+encodeURIComponent(arguments[c]);return"Minified React error #"+a+"; visit "+b+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}if(!aa)throw Error(y(227));var ba=new Set,ca={};function da(a,b){ea(a,b);ea(a+"Capture",b)}
...
function useEventCallback(fn) {
  ...
  return external_React_.useCallback((...args) => // @ts-expect-error hide `this`
...
function Unstable_TrapFocus(props) {
  ...
  const reactFocusEventTarget = external_React_.useRef(null); // This variable is useful when disableAutoFocus is true.
...
const ModalUnstyled = /*#__PURE__*/external_React_.forwardRef(function ModalUnstyled(props, ref) {
  const {
    BackdropComponent,
    BackdropProps,
    children,
...
const backdropUnstyledClasses_backdropUnstyledClasses = generateUtilityClasses('MuiBackdrop', ['root', 'invisible']);
...
const BackdropUnstyled = /*#__PURE__*/external_React_.forwardRef(function BackdropUnstyled(props, ref) {
  const {
    classes: classesProp,
    className,
    invisible = false,
...
const DialogContext = /*#__PURE__*/(0,external_React_.createContext)({});
...
function modal_hook_extends() { modal_hook_extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; }; return modal_hook_extends.apply(this, arguments); }
